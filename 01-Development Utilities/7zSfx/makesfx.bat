...
copy ..\..\%DBGREL%\KxRpc.dll Archive\Kex32\ >nul
...
copy ..\..\x64\%DBGREL%\KxRpc.dll Archive\Kex64\ >nul
...
if %DBGREL%==Debug (
	...
	copy ..\..\%DBGREL%\KxRpc.pdb Archive\Kex32\ >nul
	...
	copy ..\..\x64\%DBGREL%\KxRpc.pdb Archive\Kex64\ >nul
